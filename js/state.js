...
// ============================================================
import { IS_DEMO, IS_ADMIN, FIREBASE_CONFIG } from './config.js?v=26';
import { MEMBERSHIPS } from './catalog.js?v=26';
...
export const State = {
  ...
  async init(user) {
    ...
    try {
      ...
      fs = await import('https://www.gstatic.com/firebasejs/10.12.2/firebase-firestore.js?v=26');
