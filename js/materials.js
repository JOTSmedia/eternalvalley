...
const RECIPE_ALIASES = {
  ...
  'hohenzollernSandstone': 'agedCaenLimestone',
  'darkSlate': 'pagodaTile',
  'asamRedMarble': 'honedCarraraMarble',
  'sandstone': 'jerusalemStone'
};
...
/**
 * Build a MeshPhysicalMaterial (or Physical, for anything with a
...
export function material(name, opts = {}) {
  ...
  const Ctor = physical ? THREE.MeshPhysicalMaterial : THREE.MeshPhysicalMaterial;
  const mat = new Ctor({
    map: cloneWith(t.map),
...
export const Surfaces = {
  ...
  glowingCrystal: (repeat = 1, o = {}) => new THREE.MeshPhysicalMaterial({ color: 0xffeebb, emissive: 0xffddaa, emissiveIntensity: 2.0, roughness: 0.1, metalness: 0.1, transparent: true, opacity: 0.9, ...o }),
  ...
  byzantineMosaic: (repeat = 1, o = {}) => material('byzantineMosaic', { repeat, roughness: 0.15, metalness: 0.25, physical: true, clearcoat: 0.8, clearcoatRoughness: 0.1, normalScale: 1.2, envMapIntensity: 1.5, ...o }),
  weatheredConcrete: (repeat = 1, o = {}) => material('weatheredTravertine', { repeat, roughness: 0.85, metalness: 0.0, normalScale: 1.5, aoMapIntensity: 1.2, envMapIntensity: 1.0, ...o }),
  clearGlass: (repeat = 1, o = {}) => new THREE.MeshPhysicalMaterial({ color: 0xffffff, transmission: 0.95, opacity: 1, roughness: 0.05, ior: 1.52, thickness: 0.2, clearcoat: 1.0, envMapIntensity: 2.0, side: THREE.DoubleSide, ...o }),
  brushedMetal: (repeat = 1, o = {}) => material('iron', { repeat, roughness: 0.35, metalness: 0.85, physical: true, clearcoat: 0.3, envMapIntensity: 1.8, ...o }),
  water: (repeat = 1, o = {}) => {
