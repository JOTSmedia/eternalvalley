    ...
    for (const rg of regs) {
      for (let r = 0; r < rg.rows; r++) {
        for (let c = 0; c < rg.cols; c++) {
          ...
          // Cathedral Roof Plots (Restored for Billboard Compatibility)
          plots.push(
            { id: 'CATH_ROOF_1', district: 'cathedral_interior', x: WORLD.cathedral.x - 20, z: WORLD.cathedral.z + 10, h: terrainHeight(WORLD.cathedral.x, WORLD.cathedral.z) + 40, rot: 0, type: 'cathedral_interior', name: 'Fresco Balcony West #1', size: 'premium', tier: 3, avail: true },
            { id: 'CATH_ROOF_2', district: 'cathedral_interior', x: WORLD.cathedral.x, z: WORLD.cathedral.z - 15, h: terrainHeight(WORLD.cathedral.x, WORLD.cathedral.z) + 42, rot: 0, type: 'cathedral_interior', name: 'Gilded Rococo Altar Chancel #2', size: 'estate', tier: 4, avail: true },
            { id: 'CATH_ROOF_3', district: 'cathedral_interior', x: WORLD.cathedral.x + 20, z: WORLD.cathedral.z + 10, h: terrainHeight(WORLD.cathedral.x, WORLD.cathedral.z) + 40, rot: 0, type: 'cathedral_interior', name: 'Fresco Balcony East #3', size: 'premium', tier: 3, avail: true }
          );
