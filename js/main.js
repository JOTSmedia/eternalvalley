...
// ============================================================
import { generatePlots, DISTRICTS, PET_NAMES } from './terrain.js?v=9';
import { World3D } from './world3d.js?v=9';
import { Map2D } from './map2d.js?v=9';
import { Auth } from './auth.js?v=9';
import { State } from './state.js?v=9';
import { UI } from './ui.js?v=9';
import { SEASON_STYLE, MOODS } from './ambience.js?v=9';
import { EarthView } from './earth.js?v=9';
import { Theme } from './theme.js?v=9';
import { Atmosphere } from './atmosphere.js?v=9';
import { Motion } from './motion.js?v=9';
import { hydrate as hydrateIcons } from './icons.js?v=9';
import { warmThumbs, photosReady } from './thumbs.js?v=9';
import { CharityUI } from './charityui.js?v=9';
import { warmAllTextures } from './materials.js?v=9';
...
import { SLOTS, ITEM_DECOR, GIFT_DECOR, GIFTS, CHARITIES } from './catalog.js?v=9';
    ...
    try {
      ...
      if (mode === '3d' || mode === 'tour') {
        try {
          ...
          // FORCE the drone tour to start — unless the Veo video landing
          // is active (the video IS the tour, 3D world waits in orbit)
          if (mode === 'tour' && UI.world && !UI._veoActive) {
      ...
      try {
        ...
        if (memId) {
          const { allMemorials } = await import('./social.js?v=9');
