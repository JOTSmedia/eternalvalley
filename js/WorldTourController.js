    ...
    if (this._lastStageNum !== activeStage.stage || !card || force) {
      ...
      if (!card) {
        ...
        card.addEventListener('click', (e) => {
          ...
          if (btn.classList.contains('dtc-film')) {
            const landing = document.getElementById('veoLanding');
            if (landing) {
              landing.style.display = 'block';
              const video = document.getElementById('veoDroneVideo');
      ...
      card.innerHTML = `
        <div class="dtc-content">
          ...
          <div class="dtc-controls">
            ...
            <button class="dtc-btn dtc-film" title="Watch 56s Cinematic Film Tour" aria-label="Watch Film Tour">🎬 Film</button>
