...
export const UI = {
  ...
  async show3D(mode = 'tour', isEntrance = false) {
    // Veo cinematic drone video replaces the 3D drone tour
    if (mode === 'tour') {
      ...
      if (landing && video) {
        ...
        // Ensure 3D world builds & compiles in background so there's zero lag when transitioning
        ...
        const dismiss = (e) => {
          ...
          landing.style.transition = 'opacity 0.55s ease-out';
          landing.style.opacity = '0';
          this.show3D('orbit', true);
          setTimeout(() => {
