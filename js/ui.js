  ...
  _setupVeoInteractiveHUD(landing, video) {
    ...
    const VEO_CHAPTERS = [
      ...
      { id: 'cathedral_int', start: 28, end: 32, name: '8/14 · Asamkirche Rococo Cathedral [Interior]', badge: 'ASAMKIRCHE ROCOCO', districtKey: 'cathedral_interior', plots: [
        { id: 'CATH_ROOF_1', name: 'Fresco Balcony West #1', x: 30, y: 55, price: 749, badge: 'ASAMKIRCHE ROCOCO', desc: 'Elevated interior balcony directly beneath the gilded ceiling fresco of eternity.', flyKey: 'cathedral_interior' },
      ...
      { id: 'panorama', start: 52, end: 56, name: '14/14 · Valley Summit Panorama', badge: 'SUMMIT REST', districtKey: 'highland', plots: [
        ...
        { id: 'SUMMIT_2', name: 'Valley of Eternity Master Plot #4', x: 62, y: 70, price: 999, badge: 'SUMMIT REST', desc: 'Supreme vantage point taking in Gate, Waterfall, Cathedral, Desert, and Ocean.', flyKey: 'highland' },
      ]}
    ];
