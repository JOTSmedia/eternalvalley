...
export const DRONE_TOUR_LANDMARKS = [
  ...
  },
  {
    ...
    sub: 'Soaring high over central meadow tree crowns, descending to mist level in front of the 182m cascade, and ascending vertically to crest the waterfall lip.',
    tStart: 3/12,
    tEnd: 4/12,
    seconds: 13,
    speedScale: 0.15,
  ...
  },
  {
    ...
    title: 'Universal Cathedral & Asamkirche Rococo Nave',
    sub: 'High aerial orbit around the Hohenzollern fortress ramparts, flying straight between open oak portals down the center Asamkirche nave past Solomonic columns toward the high altar.',
    tStart: 5/12,
    tEnd: 6/12,
    seconds: 14,
    speedScale: 0.15,
  ...
  },
  {
    stage: 7,
    id: 'desert-canyon',
    title: 'Grand Canyon Desert & Pueblo Sun-Kiva',
    sub: 'Sweeping across majestic red rock badland mesas, canyon gorges, and entering the sacred Pueblo Sun-Kiva sanctuary with pine vigas, stone hearth, and sunbeam skylight.',
    tStart: 6/12,
    tEnd: 7/12,
    seconds: 14,
    speedScale: 0.15,
  ...
  },
  {
    stage: 8,
    id: 'moorish-mosque',
    title: 'Moorish Alhambra Oasis & Muqarnas Sanctuary',
    sub: 'Panoramic descent to the palace terrace, orbiting the minaret, skimming the marble reflecting pool, and flying into the honeycomb muqarnas dome sanctuary.',
    tStart: 7/12,
    tEnd: 8/12,
    seconds: 13,
    speedScale: 0.15,
  ...
  },
  {
    stage: 9,
    id: 'mirror-lake',
    title: 'Mirror Lake Underwater World & Koi Dive',
    sub: 'Descent across valley meadows, skimming lake waters beneath weeping willows, plunging into crystal depths among schools of swimming golden koi and caustic light shafts, and resurfacing into golden mist.',
    tStart: 8/12,
    tEnd: 9/12,
    seconds: 14,
    speedScale: 0.15,
  ...
  },
  {
    stage: 10,
    id: 'buddhist-pagoda',
    title: 'Five-Tiered Zen Pagoda & Buddha Sanctuary',
    sub: 'Flying past the open South Porch and tatami meditation room with golden Buddha statue before spiraling up past the 5-tiered curved eaves & Sōrin finial.',
    tStart: 9/12,
    tEnd: 10/12,
    seconds: 13,
    speedScale: 0.15,
  ...
  },
  {
    stage: 11,
    id: 'kaya-island-reef',
    title: 'Kaya Island & Pure-Bred Siberian Husky Monument',
    sub: 'Approaching Kaya Island, 360-degree orbit around the Pure-Bred Siberian Husky Kaya Statue Monument, sweeping past the Cliff Temple of Baal, and diving off the sea cliffs.',
    tStart: 10/12,
    tEnd: 11/12,
    seconds: 18,
    speedScale: 0.12,
  ...
  },
  {
    stage: 12,
    id: 'celestial-ascent',
    title: 'Coral Reef Underwater Abyss & Sunrise Ascent',
    sub: 'Submerging deep into the glowing Southern Ocean Coral Reef and Abyssal Marine Sanctuary, soaring through bioluminescent waters, and breaching the surface in radiant golden sunrise light for a panoramic valley loop.',
    tStart: 11/12,
    tEnd: 12/12,
    seconds: 12,
    speedScale: 0.15,
