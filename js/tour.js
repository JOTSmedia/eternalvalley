...
export const DRONE_TOUR_LANDMARKS = [
  ...
  },
  {
    stage: 9,
    id: 'mirror-lake',
    title: 'Mirror Lake Shallows & Underwater Dive',
  ...
  },
  {
    stage: 11,
    id: 'kaya-island-reef',
    title: 'Kaya Island, Siberian Husky Monument & Coral Reef',
    sub: 'Approaching Kaya Island, 360-degree orbit around the Pure-Bred Siberian Husky Kaya Statue Monument, sweeping past the Cliff Temple of Baal, and plunging off sea cliffs into the coral reef depths.',
    tStart: 10/12,
    tEnd: 11/12,
    seconds: 18,
    speedScale: 0.12,
  ...
  },
  {
    stage: 12,
    id: 'celestial-ascent',
    title: 'Celestial Sunrise Ascent & Grand Valley Panorama',
    sub: 'Radiant sunrise ocean breach into golden morning sunlight for a soaring high panoramic climb commanding the full valley vista, looping seamlessly back to the Grand Gate.',
    tStart: 11/12,
    tEnd: 12/12,
    seconds: 12,
    speedScale: 0.15,
